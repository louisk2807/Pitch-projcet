...
Route::post( '/PaymentMethod/create',[\App\Http\Controllers\PaymentMethodController::class, 'store'])->name('PaymentMethod.store');
Route::get( '/PaymentMethod/{id}/edit',[\App\Http\Controllers\PaymentMethodController::class, 'edit'])->name('PaymentMethod.edit');
Route::put( '/PaymentMethod/{id}/edit',[\App\Http\Controllers\PaymentMethodController::class, 'update'])->name('PaymentMethod.update');
Route::delete('/PaymentMethod/{id}', [\App\Http\Controllers\PaymentMethodController::class, 'destroy'])->name('PaymentMethod.destroy');
...
Route::get('/BookingSchedule/{id}', [\App\Http\Controllers\BookingScheduleController::class, 'updateStatus'])->name('BookingSchedule.updateStatus');
Route::get('/BookingSchedule/pay/{id}', [\App\Http\Controllers\BookingScheduleController::class, 'mini'])->name('BookingSchedule.mini');
Route::get('/BookingSchedule/restore/{id}', [\App\Http\Controllers\BookingScheduleController::class, 'restore'])->name('BookingSchedule.restore');
//
...
Route::post('/ServiceDetail/store', [\App\Http\Controllers\ServiceDetailController::class,'store'])->name('ServiceDetail.store');
...
Route::get('/fetch-booking-details/{id}', [\App\Http\Controllers\ServiceDetailController::class, 'fetchBookingDetails'])->name('ServiceDetail.fetch-booking-details');


Route::get('/SalesReport/index', [\App\Http\Controllers\SalesReportController::class, 'index'])->name('SalesReport.index');
...
Route::middleware('CustomerMiddleware')->prefix('Home')->group(function (){
    ...
    Route::get('/setYard/{pitch}',[App\Http\Controllers\HomeController:: class, 'setYard'])->name('Home.setYard');
    Route::get('/cancel-order/{order_id}', [\App\Http\Controllers\HomeController::class, 'cancelBooking'])->name('cancel.booking');
    Route::post('/checkAvailability', [\App\Http\Controllers\HomeController::class, 'checkAvailability'])->name('checkAvailability');
});
